...
#define initLogo     0   // boot logo on/off 0=off 1=on
...
void drawUI() {
  ...
  if (nRF2) u8g2.drawEllipse(62, 8, 3, 3);
  if (nRF3) u8g2.drawEllipse(72, 8, 3, 3);
  if (nRF4) u8g2.drawEllipse(82, 8, 3, 3);
